...
public class LoggerExample {
	...
	// @formatter: on
	@PostConstruct
	public void myLogExample() {
		commonsLoggingLog.info("Via CommonsLogging");
		slf4Jlog.info("Via SLF4J");
		jbossLog.info("Via JBoss log");
		javaUtilLog.info("Via Java Util log");
		log4jLog.info("Via LOG4J");
		tomcatJuliLog.info("Via Tomcat's Juli");
		commonsLoggingLog.error("My log is somthing bad", new IOException("Comms Down"));
	}
