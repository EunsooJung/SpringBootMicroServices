...
public class MicroServicesWithSpringBootApplication {
	...
	@Bean
	public CommandLineRunner exampleQuery(CarRepository repository, ElasticsearchTemplate template) {
		return (args) -> {
			System.err.println("From the repository...");
			repository.findByMakeIgnoreCase("fOrd").forEach(System.err::println);
