 ...
 */
@Component
public class RedisDemoModel implements CommandLineRunner {

	private static Log logger = LogFactory.getLog(RedisDemoModel.class);

	private final StringRedisTemplate template;

	private final SlowService service;

	public RedisDemoModel(StringRedisTemplate template, SlowService service) {
