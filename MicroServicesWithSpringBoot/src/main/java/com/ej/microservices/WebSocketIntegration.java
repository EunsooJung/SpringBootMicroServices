/**
 * https://github.com/livelessons-spring/building-microservices/blob/master/livelessons-integration/livelessons-integration-eai/src/main/java/demo/WebSocketIntegration.java
 */
...
public class WebSocketIntegration {
	...
	public ServerWebSocketContainer serverWebSocketContainer() {
		return new ServerWebSocketContainer("/message").withSockJs();
	}
	...
	public IntegrationFlow webSocketFlow(EchoService echoService) {
		return (IntegrationFlowDefinition<?> integrationFlowDefinition) -> {
			Function<String, Object> splitter = (String messagePayload) -> {
				 ...
				 * build a Message destined for that session containing the input message
				 */
